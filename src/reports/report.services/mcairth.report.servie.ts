...
@Injectable()
export class MCAIRTHReportService implements MCAIRTHReportService {
    constructor(
...
async findMCAIRTH(req: MCAIRTHReq): Promise<any> {
    let result = [];
    try {
        const resultMCAIRTH = await this.PatientformdetailsModel.aggregate([
            {
                $match: {
                    statusflag: "A",
