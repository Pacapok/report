...
@Injectable()
export class MCEXTENTHReportService implements MCEXTENTHReportService {
    constructor(
...
async findMCEXTENTH(req: MCEXTENTHReq): Promise<any> {
    let result = [];
    try {
        const resultfindMCEXTENTH = await this.PatientformdetailsModel.aggregate([
            {
                $match: {
                    statusflag: "A",
