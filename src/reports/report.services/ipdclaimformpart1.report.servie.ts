...
@Injectable()
export class IPDClaimFormPart1ReportService implements IPDClaimFormPart1ReportService {
    constructor(
...
//IPD Claim Form
async findIPDClaimFormP1(req: IPDClaimFormReq): Promise<any> {
    let result = [];
    try {
        const resultIPDClaimformsP1 = await this.PatientformdetailsModel.aggregate([
            {
                $match: {
                    statusflag: "A",
