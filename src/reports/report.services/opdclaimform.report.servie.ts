...
@Injectable()
export class OPDClaimFormReportService implements OPDClaimFormReportService {
    constructor(
...
//OPD Claim Form
async findOPDClaimForm(req: OPDClaimFormReq): Promise<any> {
    let result = [];
    try {
        const resultOPDClaimforms = await this.PatientformdetailsModel.aggregate([
            {
                $match: {
                    statusflag: "A",
