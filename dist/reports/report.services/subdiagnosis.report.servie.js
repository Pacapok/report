...
let SUBDIAGReportService = class SUBDIAGReportService {
    ...
    findSUBDIAG(req) {
        return __awaiter(this, void 0, void 0, function* () {
            let result = [];
            try {
                const resultfindSUBDIAG = yield this.PatientformdetailsModel.aggregate([
                    {
                        $match: {
                            statusflag: "A",
...
SUBDIAGReportService = __decorate([
    common_1.Injectable(),
    __param(1, mongoose_2.InjectModel('patientformdetails')),
    __metadata("design:paramtypes", [logger_1.ConsoleLogger,
        mongoose_1.Model])
], SUBDIAGReportService);
exports.SUBDIAGReportService = SUBDIAGReportService;
//# sourceMappingURL=subdiagnosis.report.servie.js.map