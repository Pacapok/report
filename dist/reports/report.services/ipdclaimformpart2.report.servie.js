...
let IPDClaimFormPart2ReportService = class IPDClaimFormPart2ReportService {
    constructor(logger, PatientformdetailsModel) {
        this.logger = logger;
        this.PatientformdetailsModel = PatientformdetailsModel;
    }
    findIPDClaimFormP2(req) {
        return __awaiter(this, void 0, void 0, function* () {
            let result = [];
            try {
                const resultIPDClaimformsP2 = yield this.PatientformdetailsModel.aggregate([
                    {
                        $match: {
                            statusflag: "A",
                    ...
                    },
                    {
                        $group: {
                            ...
                            SEC4HPIDUSYMPTOM: { "$push": { $arrayElemAt: [{
                                            $filter: {
                            ...
                            SEC4HPIFINDING: { "$push": { $arrayElemAt: [{
                                            $filter: {
                                                input: "$SEC4CHIEFCOMPLAINTS",
                                                as: "vs",
                            ...
                            SEC4PRESENTILLNESS: { "$push": { $arrayElemAt: [{
                                            $filter: {
                            ...
                            SEC4MEDICINEORDERS: { "$push": { $arrayElemAt: [{
                                            $filter: {
                            ...
                            SEC4MEDICINEORDERSTB: { "$push": { $arrayElemAt: [{
                                            $filter: {
                                                input: "$SEC4MEDICINEORDERS",
                                                as: "vs",
                                                cond: { $eq: ["$$vs.sectionname", "Treatment"] }
                            ...
                            MEDICATIONHISTORY: { "$push": { $arrayElemAt: [{
                                            $filter: {
                            ...
                            MEDICATIONHISTORYTB: { "$push": { $arrayElemAt: [{
                                            $filter: {
                                                input: "$MEDICATIONHISTORY",
                                                as: "vs",
                                                cond: { $eq: ["$$vs.sectionname", "The Patient 's Medical History"] }
                            ...
                            SEC4EXAMINATIONS: { "$push": { $arrayElemAt: [{
                                            $filter: {
                            ...
                            SEC4RADIOLOGYRESULTS: { "$push": { $arrayElemAt: [{
                                            $filter: {
...
IPDClaimFormPart2ReportService = __decorate([
    common_1.Injectable(),
    __param(1, mongoose_2.InjectModel('patientformdetails')),
    __metadata("design:paramtypes", [logger_1.ConsoleLogger,
        mongoose_1.Model])
], IPDClaimFormPart2ReportService);
exports.IPDClaimFormPart2ReportService = IPDClaimFormPart2ReportService;
//# sourceMappingURL=ipdclaimformpart2.report.servie.js.map