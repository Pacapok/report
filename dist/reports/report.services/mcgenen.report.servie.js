...
let MCGENENReportService = class MCGENENReportService {
    ...
    findMCGENEN(req) {
        return __awaiter(this, void 0, void 0, function* () {
            let result = [];
            try {
                const resultfindMCGENEN = yield this.PatientformdetailsModel.aggregate([
                    {
                        $match: {
                            statusflag: "A",
                    ...
                    {
                        $match: {
                            "formtemplates.code": "MEDICAL_CERTIFICATE_EN"
                        }
                    },
                    {
                        $lookup: {
...
MCGENENReportService = __decorate([
    common_1.Injectable(),
    __param(1, mongoose_2.InjectModel('patientformdetails')),
    __metadata("design:paramtypes", [logger_1.ConsoleLogger,
        mongoose_1.Model])
], MCGENENReportService);
exports.MCGENENReportService = MCGENENReportService;
//# sourceMappingURL=mcgenen.report.servie.js.map