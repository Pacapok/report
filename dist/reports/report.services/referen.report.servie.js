...
let REFERENReportService = class REFERENReportService {
    ...
    findREFEREN(req) {
        return __awaiter(this, void 0, void 0, function* () {
            let result = [];
            try {
                const resultfindREFEREN = yield this.PatientformdetailsModel.aggregate([
                    {
                        $match: {
                            statusflag: "A",
...
REFERENReportService = __decorate([
    common_1.Injectable(),
    __param(1, mongoose_2.InjectModel('patientformdetails')),
    __metadata("design:paramtypes", [logger_1.ConsoleLogger,
        mongoose_1.Model])
], REFERENReportService);
exports.REFERENReportService = REFERENReportService;
//# sourceMappingURL=referen.report.servie.js.map