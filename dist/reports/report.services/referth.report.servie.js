...
let REFERTHReportService = class REFERTHReportService {
    ...
    findREFERTH(req) {
        return __awaiter(this, void 0, void 0, function* () {
            let result = [];
            try {
                const resultfindREFERTH = yield this.PatientformdetailsModel.aggregate([
                    {
                        $match: {
                            statusflag: "A",
                    ...
                    {
                        $match: {
                            "formtemplates.code": "FM_REFER_TH"
                        }
                    },
                    {
                        $lookup: {
                    ...
                    {
                        $addFields: {
                            FormSection: "$patientforms.formsections"
                        }
                    },
                    {
                        $addFields: {
                            ...
                            REASONTRANSFER: {
                                $arrayElemAt: [{
                                        $filter: {
                                            input: "$attributes",
                                            as: "vs",
                                            cond: { $eq: ["$$vs.attributename", "REASONTRANSFER"] }
                                        }
                                    }, -1]
                            }
                        }
                    ...
                    },
                    {
                        $group: {
                            ...
                            REASONTRANSFER: { "$push": "$REASONTRANSFER.textvalue" },
                    ...
                    },
                    {
                        $project: {
                            ...
                            REASONTRANSFER: { $arrayElemAt: ["$REASONTRANSFER", -1] },
                ...
                result = resultfindREFERTH;
            }
            catch (error) {
                this.logger.error('findREFERTH error:', error);
            }
            return result;
        });
    }
};
REFERTHReportService = __decorate([
    common_1.Injectable(),
    __param(1, mongoose_2.InjectModel('patientformdetails')),
    __metadata("design:paramtypes", [logger_1.ConsoleLogger,
        mongoose_1.Model])
], REFERTHReportService);
exports.REFERTHReportService = REFERTHReportService;
//# sourceMappingURL=referth.report.servie.js.map