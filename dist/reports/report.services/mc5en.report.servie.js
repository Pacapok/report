...
let MC5ENReportService = class MC5ENReportService {
    ...
    findMC5EN(req) {
        return __awaiter(this, void 0, void 0, function* () {
            let result = [];
            try {
                const resultfindMC5EN = yield this.PatientformdetailsModel.aggregate([
                    {
                        $match: {
                            statusflag: "A",
...
MC5ENReportService = __decorate([
    common_1.Injectable(),
    __param(1, mongoose_2.InjectModel('patientformdetails')),
    __metadata("design:paramtypes", [logger_1.ConsoleLogger,
        mongoose_1.Model])
], MC5ENReportService);
exports.MC5ENReportService = MC5ENReportService;
//# sourceMappingURL=mc5en.report.servie.js.map